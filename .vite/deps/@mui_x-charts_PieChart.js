...
var require_createBreakpoints = __commonJS({
  "node_modules/@mui/system/createTheme/createBreakpoints.js"(exports) {
    ...
    var _excluded36 = ["values", "unit", "step"];
    ...
    function createBreakpoints2(breakpoints) {
      const {
        ...
        unit: unit2 = "px",
        step = 5
      } = breakpoints, other = (0, _objectWithoutPropertiesLoose2.default)(breakpoints, _excluded36);
...
var require_spacing = __commonJS({
  "node_modules/@mui/system/spacing.js"(exports) {
    ...
    function getValue2(transformer2, propValue) {
      ...
      const transformed = transformer2(abs2);
      if (propValue >= 0) {
        return transformed;
      }
...
var require_createTheme = __commonJS({
  "node_modules/@mui/system/createTheme/createTheme.js"(exports) {
    ...
    var _excluded36 = ["breakpoints", "palette", "spacing", "shape"];
    function createTheme3(options = {}, ...args) {
      const {
        ...
        spacing: spacingInput,
        shape: shapeInput = {}
      } = options, other = (0, _objectWithoutPropertiesLoose2.default)(options, _excluded36);
...
var require_extendSxProp = __commonJS({
  "node_modules/@mui/system/styleFunctionSx/extendSxProp.js"(exports) {
    ...
    function extendSxProp2(props) {
      const {
        sx: inSx
      } = props, other = (0, _objectWithoutPropertiesLoose2.default)(props, _excluded36);
      const {
        systemProps,
        otherProps
      } = splitProps2(other);
...
var require_createStyled = __commonJS({
  "node_modules/@mui/system/createStyled.js"(exports) {
    ...
    var _excluded37 = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
    function _getRequireWildcardCache(e) {
      if ("function" != typeof WeakMap)
        return null;
      var r2 = /* @__PURE__ */ new WeakMap(), t = /* @__PURE__ */ new WeakMap();
    ...
    function processStyleArg2(callableStyle, _ref) {
      let {
        ownerState
      } = _ref, props = (0, _objectWithoutPropertiesLoose2.default)(_ref, _excluded36);
    ...
    function createStyled5(input = {}) {
      ...
      return (tag, inputOptions = {}) => {
        ...
        } = inputOptions, options = (0, _objectWithoutPropertiesLoose2.default)(inputOptions, _excluded37);
...
true ? DrawingProvider.propTypes = {
  ...
  svgRef: import_prop_types21.default.shape({
...
function areInputsEqual(next2, prev) {
    ...
    anim.values.forEach((node2, i) => {
      ...
      if (!finished) {
        ...
        if (!is.und(config2.duration)) {
          ...
          finished = Math.abs(node2.lastPosition - position3) <= precision;
          velocity = v0 * e;
        } else {
...
function locale_default(locale3) {
  ...
  function formatPrefix2(specifier, value) {
    var f = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier)), e = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k2 = Math.pow(10, -e), prefix3 = prefixes2[8 + e / 3];
...
var CartesianContext = React42.createContext({
  xAxis: {},
  yAxis: {},
  xAxisIds: [],
  yAxisIds: []
...
function CartesianContextProvider(props) {
  ...
  const formattedSeries = React42.useContext(SeriesContext);
  const drawingArea = React42.useContext(DrawingContext);
  const xAxis = React42.useMemo(() => inXAxis == null ? void 0 : inXAxis.map((axisConfig) => {
  ...
  const yAxis = React42.useMemo(() => inYAxis == null ? void 0 : inYAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
...
var useAxisEvents = (disableAxisListener) => {
  const svgRef = React43.useContext(SVGContext);
  const {
    width: width2,
    height: height2,
    top: top3,
...
var _excluded18 = ["children", "width", "height", "viewBox", "disableAxisListener", "className"];
var ChartChartsSurfaceStyles = styled_default2("svg", {
  name: "MuiChartsSurface",
  slot: "Root"
})(() => ({}));
var ChartsSurface = React44.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width: width2,
    height: height2,
...
var HighlighContext = React45.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React45.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  const value = React45.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
  return (0, import_jsx_runtime21.jsx)(HighlighContext.Provider, {
    value,
    children
  });
}
...
var ChartContainer = React46.forwardRef(function ChartContainer2(props, ref) {
  const {
    width: width2,
    height: height2,
    series,
  ...
  const svgRef = React46.useRef(null);
  const handleRef = useForkRef(ref, svgRef);
  useReducedMotion2();
  return (0, import_jsx_runtime22.jsx)(DrawingProvider, {
    width: width2,
    height: height2,
    margin: margin2,
    svgRef,
    children: (0, import_jsx_runtime22.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime22.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime22.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime22.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime22.jsx)(ChartsSurface, {
              width: width2,
              height: height2,
              ref: handleRef,
              sx,
...
var useChartDimensions2 = (inWidth, inHeight) => {
  ...
  const displayError = React47.useRef(false);
  const [width2, setWidth] = React47.useState(0);
  const [height2, setHeight] = React47.useState(0);
  const computeSize = React47.useCallback(() => {
...
var ResponsiveChartContainer = React47.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime23.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width2 && height2 ? (0, import_jsx_runtime23.jsx)(ChartContainer, _extends({}, other, {
      width: width2,
      height: height2,
      ref
    })) : null
...
function ChartsText(props) {
  ...
  const wordsByLines = React51.useMemo(() => getWordsByLines({
    style: style4,
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React53.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
  ...
  return (0, import_jsx_runtime27.jsxs)(AxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime26.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime27.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime26.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime26.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React54.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
  ...
  const {
    ...
    width: width2,
    height: height2
  } = React54.useContext(DrawingContext);
  const tickSize = disableTicks ? 4 : tickSizeProp;
    ...
    children: [!disableLine && (0, import_jsx_runtime28.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime29.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime28.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && (0, import_jsx_runtime28.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
...
true ? ChartsAxis.propTypes = {
   ...
   */
  bottomAxis: import_prop_types27.default.oneOfType([import_prop_types27.default.shape({
   ...
   */
  leftAxis: import_prop_types27.default.oneOfType([import_prop_types27.default.shape({
    axisId: import_prop_types27.default.oneOfType([import_prop_types27.default.number, import_prop_types27.default.string]),
    classes: import_prop_types27.default.object,
    disableLine: import_prop_types27.default.bool,
    disableTicks: import_prop_types27.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types27.default.oneOfType([import_prop_types27.default.shape({
    axisId: import_prop_types27.default.oneOfType([import_prop_types27.default.number, import_prop_types27.default.string]),
    classes: import_prop_types27.default.object,
    disableLine: import_prop_types27.default.bool,
    disableTicks: import_prop_types27.default.bool,
   ...
   * @default null
   */
  topAxis: import_prop_types27.default.oneOfType([import_prop_types27.default.shape({
    axisId: import_prop_types27.default.oneOfType([import_prop_types27.default.number, import_prop_types27.default.string]),
    classes: import_prop_types27.default.object,
    disableLine: import_prop_types27.default.bool,
    disableTicks: import_prop_types27.default.bool,
...
var Portal = React56.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React56.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var PopperTooltip = React57.forwardRef(function PopperTooltip2(props, forwardedRef) {
  var _slots$root;
  const {
    anchorEl,
    children,
...
var Popper = React57.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
...
function useMouseTracker() {
  const svgRef = React59.useContext(SVGContext);
  const [mousePosition, setMousePosition] = React59.useState(null);
  React59.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React61.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
  ...
  return (0, import_jsx_runtime37.jsx)(Content, _extends({}, chartTooltipContentProps));
}
true ? ChartsItemTooltipContent.propTypes = {
  ...
  content: import_prop_types32.default.elementType,
  contentProps: import_prop_types32.default.shape({
    classes: import_prop_types32.default.object,
    itemData: import_prop_types32.default.shape({
      ...
      type: import_prop_types32.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
    }),
    series: import_prop_types32.default.shape({
      color: import_prop_types32.default.string,
      data: import_prop_types32.default.oneOfType([import_prop_types32.default.arrayOf(import_prop_types32.default.number), import_prop_types32.default.arrayOf(import_prop_types32.default.number), import_prop_types32.default.arrayOf(import_prop_types32.default.shape({
        ...
        x: import_prop_types32.default.number.isRequired,
        y: import_prop_types32.default.number.isRequired
      })), import_prop_types32.default.arrayOf(import_prop_types32.default.shape({
      ...
      id: import_prop_types32.default.oneOfType([import_prop_types32.default.number, import_prop_types32.default.string]).isRequired,
      type: import_prop_types32.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired,
      valueFormatter: import_prop_types32.default.func.isRequired
    }),
...
var Typography = React62.forwardRef(function Typography2(inProps, ref) {
  ...
  return (0, import_jsx_runtime38.jsx)(TypographyRoot, _extends({
    as: Component,
    ref,
    ownerState,
    className: clsx_default(classes.root, className)
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime39.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime40.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime39.jsx)("thead", {
        children: (0, import_jsx_runtime39.jsx)(ChartsTooltipRow, {
      ...
      }), (0, import_jsx_runtime39.jsx)("tbody", {
        children: series.map(({
          color: color3,
          id,
          label,
          ...
          return (0, import_jsx_runtime40.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime39.jsx)(ChartsTooltipCell, {
              ...
              className: clsx_default(classes.labelCell, classes.cell),
              children: label ? (0, import_jsx_runtime39.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime39.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.valueCell, classes.cell),
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types34.default.object.isRequired,
  /**
   ...
   */
  axisValue: import_prop_types34.default.any.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * The series linked to the triggered axis.
   */
  series: import_prop_types34.default.arrayOf(import_prop_types34.default.object).isRequired,
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  content: import_prop_types35.default.elementType,
  contentProps: import_prop_types35.default.shape({
    axis: import_prop_types35.default.object,
    axisData: import_prop_types35.default.shape({
      x: import_prop_types35.default.shape({
        index: import_prop_types35.default.number,
        value: import_prop_types35.default.oneOfType([import_prop_types35.default.instanceOf(Date), import_prop_types35.default.number, import_prop_types35.default.string]).isRequired
    ...
    axisValue: import_prop_types35.default.any,
    classes: import_prop_types35.default.object,
    dataIndex: import_prop_types35.default.number,
    series: import_prop_types35.default.arrayOf(import_prop_types35.default.object),
...
function DefaultChartsLegend(props) {
  ...
  const seriesWithPosition = React66.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
  ...
  return (0, import_jsx_runtime43.jsx)(NoSsr, {
    children: (0, import_jsx_runtime43.jsx)(ChartsLegendRoot, {
      className: classes.root,
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = React66.useContext(DrawingContext);
  const series = React66.useContext(SeriesContext);
  ...
  return (0, import_jsx_runtime43.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function ChartsAxisHighlight(props) {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React68.useContext(CartesianContext);
  ...
  return (0, import_jsx_runtime46.jsxs)(React68.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime45.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime45.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime45.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime45.jsx)(ChartsAxisHighlightPath, {
...
var useInteractionItemProps = (scope) => {
  ...
  } = React69.useContext(HighlighContext);
...
function PieArc(props) {
  ...
  return (0, import_jsx_runtime47.jsx)(PieArcRoot, _extends({
...
function useTransformData(series) {
  ...
  const getHighlightStatus = React71.useCallback((dataIndex) => {
  ...
  const dataWithHighlight = React71.useMemo(() => data.map((item, itemIndex) => {
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime48.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index2) => {
      ...
      return (0, import_jsx_runtime48.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime49.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime50.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime50.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PiePlot(props) {
  ...
  const seriesData = React75.useContext(SeriesContext).pie;
  const {
    left: left3,
    top: top3,
    width: width2,
  ...
  return (0, import_jsx_runtime52.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime51.jsx)("g", {
        transform: `translate(${left3 + cx}, ${top3 + cy})`,
        children: (0, import_jsx_runtime51.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime51.jsx)("g", {
        transform: `translate(${left3 + cx}, ${top3 + cy})`,
        children: (0, import_jsx_runtime51.jsx)(PieArcLabelPlot, {
          innerRadius,
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime54.jsxs)(ResponsiveChartContainer, {
    ...
    children: [(0, import_jsx_runtime53.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime53.jsx)(PiePlot, {
      slots,
      slotProps,
      onClick,
      skipAnimation: skipAnimation2
    }), (0, import_jsx_runtime53.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime53.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime53.jsx)(ChartsTooltip, _extends({}, tooltip)), children]
  });
}
true ? PieChart.propTypes = {
   ...
   * @default null
   */
  bottomAxis: import_prop_types44.default.oneOfType([import_prop_types44.default.shape({
    ...
    position: import_prop_types44.default.oneOf(["bottom", "top"]),
   ...
   * @default null
   */
  leftAxis: import_prop_types44.default.oneOfType([import_prop_types44.default.shape({
    axisId: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]),
    classes: import_prop_types44.default.object,
    disableLine: import_prop_types44.default.bool,
    disableTicks: import_prop_types44.default.bool,
    ...
    labelFontSize: import_prop_types44.default.number,
    labelStyle: import_prop_types44.default.object,
    position: import_prop_types44.default.oneOf(["left", "right"]),
    slotProps: import_prop_types44.default.object,
    slots: import_prop_types44.default.object,
    stroke: import_prop_types44.default.string,
    tickFontSize: import_prop_types44.default.number,
   ...
   * @default null
   */
  rightAxis: import_prop_types44.default.oneOfType([import_prop_types44.default.shape({
    axisId: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]),
    classes: import_prop_types44.default.object,
    disableLine: import_prop_types44.default.bool,
    disableTicks: import_prop_types44.default.bool,
  ...
  series: import_prop_types44.default.arrayOf(import_prop_types44.default.shape({
    ...
    arcLabelRadius: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]),
    color: import_prop_types44.default.string,
    cornerRadius: import_prop_types44.default.number,
    cx: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]),
    cy: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]),
    ...
    endAngle: import_prop_types44.default.number,
    ...
    id: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]),
    innerRadius: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]),
    outerRadius: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]),
    paddingAngle: import_prop_types44.default.number,
    sortingValues: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["asc", "desc", "none"]), import_prop_types44.default.func]),
    startAngle: import_prop_types44.default.number,
    type: import_prop_types44.default.oneOf(["pie"]),
   ...
   * @default null
   */
  topAxis: import_prop_types44.default.oneOfType([import_prop_types44.default.shape({
    axisId: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]),
    classes: import_prop_types44.default.object,
    disableLine: import_prop_types44.default.bool,
    disableTicks: import_prop_types44.default.bool,
